...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_z0x1htt', 'template_w7wsgmu', form.current, 'Dg9Ke35rdU-swI1yg')
            .then((result) => {
                console.log("success", result.text)
                notifySuccess("Thank you for your message! We will get back to you as soon as possible.")
            }, (error) => {
                console.log("error", error.text)
                notifyError("Oops, something went wrong. Please try submitting your message again.")
            });
        e.target.reset()
    };
                ...
                <div className="contact__content">
                    ...
                    <div className="contact__info">
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">ncpyolcu@gmail.com</span>
                            <a href="mailto:ncpyolcu@gmail.com" className="contact__button">
                                Write to me{" "}
